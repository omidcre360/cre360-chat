...
const { OpenAI } = require("// server.js — CRE360 Signal API (forms + live rates, ASCII-safe)
const express = require("express");
const cors = require("cors");
...
app.get("/console", (_req, res) => {
  ...
  const html = [
    ...
    // Greeting
    "bub('⚠️ I do not provide investment advice. But I\'ll do my best to help you analyze CRE360 signals, underwriting, and development risks.','t');",
